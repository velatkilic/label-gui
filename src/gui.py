...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setTabOrder(self.button_process_video, self.button_cluster)
        MainWindow.setTabOrder(self.button_cluster, self.radio_annot_on)
